...
export const envSchema = z.object({
  ...
  /**
   * The maximum number of seconds to wait for a job to be added to the queue
   * before timing out.
   */
  ...
  ENCRYPTION_METHOD: z.string().default('aes-256-cbc'),

  ENCRYPTION_KEY: z.string().min(10, 'ENCRYPTION_KEY is required'),

  ENCRYPTION_IV: z.string().min(10, 'ENCRYPTION_IV is required'),
